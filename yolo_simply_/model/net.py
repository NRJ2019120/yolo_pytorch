...
class Yolo_V2(nn.Module):
    def __init__(self):
       ...
       # n*3*224*224 -> n*1000*7*7
        self.layer0 = nn.Sequential(     #19 个卷积＋５个最大池化
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(1024,1000,1,1),     #13*13*1000
        )

        self.cond = nn.Sequential(
            nn.Conv2d(1000,9,1,1),        #13*13*9
            nn.Sigmoid()                  #分类器
        )
        self.offset = nn.Sequential(
            nn.Conv2d(1000,36,1,1),      #13*13*36
        )
